...
$(document).ready(function () {
  ...
  var $main_search_form = jQuery('#searchGadget_form');
  
  $main_search_form.submit(function(e) {
  	e.preventDefault();
  	var searchable_text = $main_search_form.find('input[name="SearchableText"]').val();
    document.location.href = $main_search_form.attr('facetedaction')+"#c5="+searchable_text;
...
jQuery(document).ready(function($){
	...
	$("#MainContent_ctrlAccountOptionsCheckoutBasket_btnRegister").attr("href", "");
	$("#MainContent_ctrlAccountOptionsCheckoutBasket_btnRegister").on("click", function(e) { 
		e.preventDefault(); 
		$([document.documentElement, document.body]).animate({
	        scrollTop: $("#MainContent_updTotal").offset().top
	    }, 500);
	});
...
$clone.appendTo($panel.find(".panel-content"));$panel.appendTo($parent)};var $holder=$("<div class='eea-accordion-panels collapsed-by-default non-exclusive' />");
...
/*require([
  ...
  if (window.parent === window) {
    jQuery(document).ready(function() {
      jQuery('body').addClass('centraalmuseum-main');
    });
  }
});*/
